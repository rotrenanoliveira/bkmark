import { QrCodeIcon, RefreshCcwIcon, TicketIcon, ViewIcon } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col min-h-screen w-screen">
      ...
      <main className="w-full flex flex-col items-center py-6 space-y-4">
        <div className="w-full max-w-sm flex flex-col gap-4 ring-foreground/10 bg-card text-card-foreground overflow-hidden rounded-xl py-4 text-sm ring-1 group/card">
          ...
          <div className="space-y-4 px-4">
            <div className="flex flex-col gap-2 ">
              ...
              <span className="text-muted-foreground text-sm">
                Enter the access code to synchronize your bookmarks.
              </span>
            </div>
            <SyncForm />
          </div>
